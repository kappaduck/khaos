...
public sealed class BorrowedUtf8StringMarshallerTests
{
    [Test]
    [Arguments("")]
    [Arguments("café")]
    ...
    {
        string? marshalled = BorrowedUtf8StringMarshaller.ConvertToManaged(null);
    ...
    private static string? Convert(string value)
    {
        ...
        fixed (byte* ptr = text)
            return BorrowedUtf8StringMarshaller.ConvertToManaged(ptr);
    }
}
